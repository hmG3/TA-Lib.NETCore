...
namespace TALib
{
    ...
    {
        public static RetCode RocR100(int startIdx, int endIdx, double[] inReal, int optInTimePeriod, ref int outBegIdx,
        ...
        public static RetCode RocR100(int startIdx, int endIdx, float[] inReal, int optInTimePeriod, ref int outBegIdx,
            ref int outNBElement, double[] outReal)
        {
            if (startIdx < 0)
            {
