...
namespace TALib
{
    ...
    {
        public static RetCode RocR(int startIdx, int endIdx, double[] inReal, ref int outBegIdx, ref int outNBElement, double[] outReal,
        ...
        public static RetCode RocR(int startIdx, int endIdx, decimal[] inReal, ref int outBegIdx, ref int outNBElement, decimal[] outReal,
            int optInTimePeriod = 10)
        {
            if (startIdx < 0 || endIdx < 0 || endIdx < startIdx)
            {
