...
namespace TALib
{
    ...
    {
        public static RetCode HtSine(int startIdx, int endIdx, double[] inReal, ref int outBegIdx, ref int outNBElement, double[] outSine,
            double[] outLeadSine)
        {
            ...
            int lookbackTotal = (int) Globals.UnstablePeriod[(int) FuncUnstId.HtSine] + 63;
        ...
        public static RetCode HtSine(int startIdx, int endIdx, decimal[] inReal, ref int outBegIdx, ref int outNBElement, decimal[] outSine,
            decimal[] outLeadSine)
        {
            ...
            decimal deg2Rad = Decimal.One / rad2Deg;
        ...
        {
            return (int) Globals.UnstablePeriod[(int) FuncUnstId.HtSine] + 63;
        }
    }
}
