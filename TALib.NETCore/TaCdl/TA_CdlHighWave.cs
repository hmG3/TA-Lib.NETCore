...
namespace TALib
{
    ...
    {
        public static RetCode CdlHighWave(int startIdx, int endIdx, double[] inOpen, double[] inHigh, double[] inLow, double[] inClose,
            ref int outBegIdx, ref int outNBElement, int[] outInteger)
        {
            ...
            int shadowTrailingIdx = startIdx - Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].AvgPeriod;
            ...
            if (Math.Abs(inClose[i] - inOpen[i]) < Globals.CandleSettings[(int) CandleSettingType.BodyShort].Factor * num44 / num38)
            {
                ...
                {
                    num36 = shadowPeriodTotal / Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].AvgPeriod;
                }
                else
                {
                    double num35;
                ...
                var num30 = Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].RangeType == RangeType.Shadows ? 2.0 : 1.0;

                if (inHigh[i] - num37 > Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].Factor * num36 / num30)
                {
                    double num28;
                    double num29;
                    if (inClose[i] >= inOpen[i])
                    ...
                    if (Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].AvgPeriod != 0)
                    {
                        num28 = shadowPeriodTotal / Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].AvgPeriod;
                    }
                    else
                    {
                        double num27;
                    ...
                    var num22 = Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].RangeType == RangeType.Shadows ? 2.0 : 1.0;

                    if (num29 - inLow[i] > Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].Factor * num28 / num22)
                    {
                        int num21;
                        if (inClose[i] >= inOpen[i])
                        {
        ...
        public static RetCode CdlHighWave(int startIdx, int endIdx, decimal[] inOpen, decimal[] inHigh, decimal[] inLow, decimal[] inClose,
            ref int outBegIdx, ref int outNBElement, int[] outInteger)
        {
            decimal num5;
            decimal num10;
                ...
                (decimal) Globals.CandleSettings[(int) CandleSettingType.BodyShort].Factor * num44 / num38)
            {
                ...
                var num30 = Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].RangeType == RangeType.Shadows ? 2m : 1m;

                if (inHigh[i] - num37 > (decimal) Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].Factor * num36 / num30)
                {
                    decimal num28;
                    decimal num29;
                    if (inClose[i] >= inOpen[i])
                    ...
                    var num22 = Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].RangeType == RangeType.Shadows ? 2m : 1m;

                    if (num29 - inLow[i] > (decimal) Globals.CandleSettings[(int) CandleSettingType.ShadowVeryLong].Factor * num28 / num22)
                    {
                        int num21;
                        if (inClose[i] >= inOpen[i])
                        {
