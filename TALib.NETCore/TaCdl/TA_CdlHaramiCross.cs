...
namespace TALib
{
    ...
    {
        public static RetCode CdlHaramiCross(int startIdx, int endIdx, double[] inOpen, double[] inHigh, double[] inLow, double[] inClose,
        ...
        public static RetCode CdlHaramiCross(int startIdx, int endIdx, decimal[] inOpen, decimal[] inHigh, decimal[] inLow,
        ...
        {
            return Math.Max(TA_CandleAvgPeriod(CandleSettingType.BodyDoji), TA_CandleAvgPeriod(CandleSettingType.BodyLong)) + 1;
        }
    }
}
