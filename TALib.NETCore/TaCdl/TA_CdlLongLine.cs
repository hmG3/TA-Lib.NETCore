...
namespace TALib
{
    public partial class Core
    {
            ...
            ref int outBegIdx, ref int outNBElement, int[] outInteger)
        {
            ...
            int bodyTrailingIdx = startIdx - Globals.CandleSettings[(int) CandleSettingType.BodyLong].AvgPeriod;
            ...
            {
                num44 = bodyPeriodTotal / Globals.CandleSettings[(int) CandleSettingType.BodyLong].AvgPeriod;
            }
            else
            {
                double num43;
