...
public static partial class Functions<T> where T : IFloatingPointIeee754<T>
{
        ...
        out int outNbElement, int optInTimePeriod = 14)
    {
        ...
        if (inHigh == null || inLow == null || outReal == null || optInTimePeriod is < 2 or > 100000)
        {
    ...
    public static int MidPriceLookback(int optInTimePeriod = 14) => optInTimePeriod is < 2 or > 100000 ? -1 : optInTimePeriod - 1;
}
