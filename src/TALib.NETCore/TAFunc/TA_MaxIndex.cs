namespace TALib
{
    ...
    {
        public static RetCode MaxIndex(double[] inReal, int startIdx, int endIdx, int[] outInteger, out int outBegIdx, out int outNbElement,
        ...
        public static RetCode MaxIndex(decimal[] inReal, int startIdx, int endIdx, out int outBegIdx, out int outNbElement,
