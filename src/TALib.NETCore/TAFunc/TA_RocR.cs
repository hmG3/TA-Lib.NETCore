...
{
    public static Core.RetCode RocR(T[] inReal, int startIdx, int endIdx, T[] outReal, out int outBegIdx, out int outNbElement,
    ...
    public static int RocRLookback(int optInTimePeriod = 10) => optInTimePeriod is < 1 or > 100000 ? -1 : optInTimePeriod;
}
