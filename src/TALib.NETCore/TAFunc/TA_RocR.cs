...
namespace TALib
{
    ...
    {
        public static RetCode RocR(int startIdx, int endIdx, double[] inReal, out int outBegIdx, out int outNbElement, double[] outReal,
        ...
        public static RetCode RocR(int startIdx, int endIdx, decimal[] inReal, out int outBegIdx, out int outNbElement, decimal[] outReal,
            int optInTimePeriod = 10)
        {
            outBegIdx = outNbElement = 0;
