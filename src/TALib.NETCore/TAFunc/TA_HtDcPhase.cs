...
namespace TALib
{
    ...
    {
        public static RetCode HtDcPhase(int startIdx, int endIdx, double[] inReal, out int outBegIdx, out int outNbElement,
            double[] outReal)
        {
        ...
        public static RetCode HtDcPhase(int startIdx, int endIdx, decimal[] inReal, out int outBegIdx, out int outNbElement,
            decimal[] outReal)
        {
            outBegIdx = outNbElement = 0;
