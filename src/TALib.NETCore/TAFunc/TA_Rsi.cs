...
namespace TALib
{
    ...
    {
        public static RetCode Rsi(int startIdx, in int endIdx, double[] inReal, out int outBegIdx, out int outNbElement, double[] outReal,
        ...
        public static RetCode Rsi(int startIdx, in int endIdx, decimal[] inReal, out int outBegIdx, out int outNbElement, decimal[] outReal,
            int optInTimePeriod = 14)
        {
            outBegIdx = outNbElement = 0;
