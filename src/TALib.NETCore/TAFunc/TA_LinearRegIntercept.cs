namespace TALib
{
    ...
    {
        public static RetCode LinearRegIntercept(int startIdx, int endIdx, double[] inReal, out int outBegIdx, out int outNbElement,
        ...
        public static RetCode LinearRegIntercept(int startIdx, int endIdx, decimal[] inReal, out int outBegIdx, out int outNbElement,
