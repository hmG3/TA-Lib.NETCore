...
{
    public static Core.RetCode HtDcPeriod(double[] inReal, int startIdx, int endIdx, double[] outReal, out int outBegIdx,
    ...
    public static Core.RetCode HtDcPeriod(decimal[] inReal, int startIdx, int endIdx, decimal[] outReal, out int outBegIdx,
        out int outNbElement)
    {
        outBegIdx = outNbElement = 0;
