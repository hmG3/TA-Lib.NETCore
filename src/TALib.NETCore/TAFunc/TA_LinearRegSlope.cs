...
{
    public static Core.RetCode LinearRegSlope(double[] inReal, int startIdx, int endIdx, double[] outReal, out int outBegIdx,
    ...
    public static Core.RetCode LinearRegSlope(decimal[] inReal, int startIdx, int endIdx, decimal[] outReal, out int outBegIdx,
        out int outNbElement, int optInTimePeriod = 14)
    {
        outBegIdx = outNbElement = 0;
