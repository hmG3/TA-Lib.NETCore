namespace TALib
{
    ...
    {
        public static RetCode LinearRegSlope(int startIdx, int endIdx, double[] inReal, out int outBegIdx, out int outNbElement,
        ...
        public static RetCode LinearRegSlope(int startIdx, int endIdx, decimal[] inReal, out int outBegIdx, out int outNbElement,
