...
{
    public static Core.RetCode CdlDragonflyDoji(double[] inOpen, double[] inHigh, double[] inLow, double[] inClose, int startIdx, int endIdx,
    ...
    public static Core.RetCode CdlDragonflyDoji(decimal[] inOpen, decimal[] inHigh, decimal[] inLow, decimal[] inClose, int startIdx,
    ...
    public static int CdlDragonflyDojiLookback() =>
        Math.Max(Core.CandleSettings.Get(Core.CandleSettingType.BodyDoji).AveragePeriod, Core.CandleSettings.Get(Core.CandleSettingType.ShadowVeryShort).AveragePeriod) + 1;
}
