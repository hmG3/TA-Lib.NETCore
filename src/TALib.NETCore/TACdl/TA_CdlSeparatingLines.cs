...
namespace TALib
{
    ...
    {
        public static RetCode CdlSeparatingLines(double[] inOpen, double[] inHigh, double[] inLow, double[] inClose, int startIdx,
        ...
        public static RetCode CdlSeparatingLines(decimal[] inOpen, decimal[] inHigh, decimal[] inLow, decimal[] inClose, int startIdx,
            int endIdx, int[] outInteger, out int outBegIdx, out int outNbElement)
        {
            outBegIdx = outNbElement = 0;
