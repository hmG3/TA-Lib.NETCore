namespace TALib
{
    ...
    {
        public static RetCode CdlPiercing(double[] inOpen, double[] inHigh, double[] inLow, double[] inClose, int startIdx, int endIdx,
        ...
        public static RetCode CdlPiercing(decimal[] inOpen, decimal[] inHigh, decimal[] inLow, decimal[] inClose, int startIdx, int endIdx,
            int[] outInteger, out int outBegIdx, out int outNbElement)
        {
            outBegIdx = outNbElement = 0;
        ...
        public static int CdlPiercingLookback() => TA_CandleAvgPeriod(CandleSettingType.BodyLong) + 1;
    }
}
