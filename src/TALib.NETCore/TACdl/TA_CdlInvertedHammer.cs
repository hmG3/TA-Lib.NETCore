...
{
    public static Core.RetCode CdlInvertedHammer(double[] inOpen, double[] inHigh, double[] inLow, double[] inClose, int startIdx,
        int endIdx, int[] outInteger, out int outBegIdx, out int outNbElement)
    {
        ...
        do
        {
            if (Core.TA_RealBody(inClose, inOpen, i) <
                ...
                Core.TA_RealBodyGapDown(inOpen, inClose, i, i - 1)) // gap down
            {
    ...
    public static Core.RetCode CdlInvertedHammer(decimal[] inOpen, decimal[] inHigh, decimal[] inLow, decimal[] inClose, int startIdx,
        int endIdx, int[] outInteger, out int outBegIdx, out int outNbElement)
    {
        outBegIdx = outNbElement = 0;
