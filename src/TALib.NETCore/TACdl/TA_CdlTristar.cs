...
{
    public static Core.RetCode CdlTristar(T[] inOpen, T[] inHigh, T[] inLow, T[] inClose, int startIdx, int endIdx,
    ...
    public static int CdlTristarLookback() => TA_CandleAveragePeriod(Core.CandleSettingType.BodyDoji) + 2;
}
