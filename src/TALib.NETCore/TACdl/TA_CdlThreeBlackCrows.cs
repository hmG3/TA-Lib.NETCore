...
{
    public static Core.RetCode CdlThreeBlackCrows(double[] inOpen, double[] inHigh, double[] inLow, double[] inClose, int startIdx, int endIdx,
    ...
    public static Core.RetCode CdlThreeBlackCrows(decimal[] inOpen, decimal[] inHigh, decimal[] inLow, decimal[] inClose, int startIdx,
