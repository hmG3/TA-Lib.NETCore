...
{
    public static Core.RetCode CdlIdenticalThreeCrows(double[] inOpen, double[] inHigh, double[] inLow, double[] inClose, int startIdx,
    ...
    public static Core.RetCode CdlIdenticalThreeCrows(decimal[] inOpen, decimal[] inHigh, decimal[] inLow, decimal[] inClose, int startIdx,
        int endIdx, int[] outInteger, out int outBegIdx, out int outNbElement)
    {
        outBegIdx = outNbElement = 0;
