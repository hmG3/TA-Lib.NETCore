...
{
    public static Core.RetCode CdlMatchingLow(double[] inOpen, double[] inHigh, double[] inLow, double[] inClose, int startIdx, int endIdx,
        int[] outInteger, out int outBegIdx, out int outNbElement)
    {
        ...
        do
        {
            if (!Core.TA_CandleColor(inClose, inOpen, i - 1) && // first black
                !Core.TA_CandleColor(inClose, inOpen, i) && // second black
    ...
    public static Core.RetCode CdlMatchingLow(decimal[] inOpen, decimal[] inHigh, decimal[] inLow, decimal[] inClose, int startIdx,
    ...
    public static int CdlMatchingLowLookback() => Core.CandleSettings.Get(Core.CandleSettingType.Equal).AveragePeriod + 1;
}
