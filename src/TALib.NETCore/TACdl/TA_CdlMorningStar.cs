...
{
    public static Core.RetCode CdlMorningStar(double[] inOpen, double[] inHigh, double[] inLow, double[] inClose, int startIdx, int endIdx,
    ...
    public static Core.RetCode CdlMorningStar(decimal[] inOpen, decimal[] inHigh, decimal[] inLow, decimal[] inClose, int startIdx,
