...
public static partial class Functions
{
    ...
    /// </returns>
    /// <remarks>
    /// Cos applies the cosine function to each data point in a series, primarily for advanced mathematical modeling,
    ...
    /// <summary>
    /// Returns the lookback period for <see cref="Cos{T}">Cos</see>.
    /// </summary>
