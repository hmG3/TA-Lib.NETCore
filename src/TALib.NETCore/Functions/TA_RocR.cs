...
public static partial class Functions
{
    ...
    public static Core.RetCode RocR<T>(
        ...
        RocRImpl(inReal, startIdx, endIdx, outReal, out outBegIdx, out outNbElement, optInTimePeriod);
    ...
    private static Core.RetCode RocR<T>(
        ...
        out int outNbElement,
        int optInTimePeriod = 10) where T : IFloatingPointIeee754<T> =>
        RocRImpl<T>(inReal, startIdx, endIdx, outReal, out outBegIdx, out outNbElement, optInTimePeriod);
