...
public static partial class Functions
{
    ...
    public static Core.RetCode LinearRegAngle<T>(
        ...
        LinearRegAngleImpl(inReal, startIdx, endIdx, outReal, out outBegIdx, out outNbElement, optInTimePeriod);
    ...
    private static Core.RetCode LinearRegAngle<T>(
        ...
        out int outNbElement,
        int optInTimePeriod = 14) where T : IFloatingPointIeee754<T> =>
        LinearRegAngleImpl<T>(inReal, startIdx, endIdx, outReal, out outBegIdx, out outNbElement, optInTimePeriod);
