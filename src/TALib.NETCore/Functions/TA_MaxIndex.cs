...
public static partial class Functions
{
    ...
    public static Core.RetCode MaxIndex<T>(
        ...
        MaxIndexImpl(inReal, startIdx, endIdx, outInteger, out outBegIdx, out outNbElement, optInTimePeriod);
    ...
    private static Core.RetCode MaxIndex<T>(
        ...
        out int outNbElement,
        int optInTimePeriod = 30) where T : IFloatingPointIeee754<T> =>
        MaxIndexImpl<T>(inReal, startIdx, endIdx, outInteger, out outBegIdx, out outNbElement, optInTimePeriod);
