...
public static partial class Functions
{
    ...
    /// <para>
    /// The function can be integrated with <see cref="MinusDM{T}">-DM</see> and <see cref="Adx{T}">ADX</see> to provide
    ...
    ///   <item>
    ///     <description>
    ///       Comparing <c>+DI</c> (from <see cref="PlusDI{T}">+DI</see>) and <c>-DI</c> can help identify trend direction:
    ...
    /// <summary>
    /// Returns the lookback period for <see cref="MinusDI{T}">MinusDI</see>.
    /// </summary>
    /// <param name="optInTimePeriod">The time period.</param>
