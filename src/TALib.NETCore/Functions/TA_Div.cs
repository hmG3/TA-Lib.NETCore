...
public static partial class Functions
{
    ...
    public static Core.RetCode Div<T>(
        ...
        DivImpl(inReal0, inReal1, startIdx, endIdx, outReal, out outBegIdx, out outNbElement);
    ...
    private static Core.RetCode Div<T>(
        ...
        out int outBegIdx,
        out int outNbElement) where T : IFloatingPointIeee754<T> =>
        DivImpl<T>(inReal0, inReal1, startIdx, endIdx, outReal, out outBegIdx, out outNbElement);
