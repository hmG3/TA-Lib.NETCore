...
public static partial class Functions
{
    ...
    /// </returns>
    /// <remarks>
    /// LOG10 applies a base-10 logarithmic transformation, similar in purpose to LN.
    /// <para>
    /// The function can assist in scale normalization. Employing it in broader quantitative strategies may enhance data
    ...
    /// <summary>
    /// Returns the lookback period for <see cref="Log10{T}">Log10</see>.
    /// </summary>
