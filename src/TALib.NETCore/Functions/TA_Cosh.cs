...
public static partial class Functions
{
    ...
    /// </returns>
    /// <remarks>
    /// Cosh applies the hyperbolic cosine function to each data point in a series, primarily for advanced mathematical modeling,
    ...
    /// <summary>
    /// Returns the lookback period for <see cref="Cosh{T}">Cosh</see>.
    /// </summary>
