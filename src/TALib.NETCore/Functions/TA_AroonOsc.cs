...
public static partial class Functions
{
    ...
    public static Core.RetCode AroonOsc<T>(
        ...
        AroonOscImpl(inHigh, inLow, startIdx, endIdx, outReal, out outBegIdx, out outNbElement, optInTimePeriod);
    ...
    private static Core.RetCode AroonOsc<T>(
        ...
        out int outNbElement,
        int optInTimePeriod = 14) where T : IFloatingPointIeee754<T> =>
        AroonOscImpl<T>(inHigh, inLow, startIdx, endIdx, outReal, out outBegIdx, out outNbElement, optInTimePeriod);
