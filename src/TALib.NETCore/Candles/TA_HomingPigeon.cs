...
public static partial class Candles
{
    ...
    public static Core.RetCode HomingPigeon<T>(
        ...
        HomingPigeonImpl(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
    ...
    private static Core.RetCode HomingPigeon<T>(
        ...
        out int outBegIdx,
        out int outNbElement) where T : IFloatingPointIeee754<T> =>
        HomingPigeonImpl<T>(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
