...
public static partial class Candles<T> where T : IFloatingPointIeee754<T>
{
    ...
    /// </remarks>
    private static Core.RetCode UpDownSideGapThreeMethods(
        T[] inOpen,
        T[] inHigh,
        T[] inLow,
        T[] inClose,
        int startIdx,
        int endIdx,
        int[] outInteger) => UpDownSideGapThreeMethods(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outInteger, out _, out _);
}
