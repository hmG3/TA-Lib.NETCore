...
public static partial class Candles
{
    ...
    public static Core.RetCode ConcealingBabySwallow<T>(
        ...
        ConcealingBabySwallowImpl(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
    ...
    private static Core.RetCode ConcealingBabySwallow<T>(
        ...
        out int outBegIdx,
        out int outNbElement) where T : IFloatingPointIeee754<T> =>
        ConcealingBabySwallowImpl<T>(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
