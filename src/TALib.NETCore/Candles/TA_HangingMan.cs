...
public static partial class Candles
{
    ...
    public static Core.RetCode HangingMan<T>(
        ...
        HangingManImpl(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
    ...
    private static Core.RetCode HangingMan<T>(
        ...
        out int outBegIdx,
        out int outNbElement) where T : IFloatingPointIeee754<T> =>
        HangingManImpl<T>(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
