...
{
    public static Core.RetCode Breakaway(T[] inOpen, T[] inHigh, T[] inLow, T[] inClose, int startIdx, int endIdx,
    ...
    public static int BreakawayLookback() => TA_CandleAveragePeriod(Core.CandleSettingType.BodyLong) + 4;
}
