...
public static partial class Candles
{
    ...
    public static Core.RetCode RisingFallingThreeMethods<T>(
        ...
        RisingFallingThreeMethodsImpl(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
    ...
    private static Core.RetCode RisingFallingThreeMethods<T>(
        ...
        out int outBegIdx,
        out int outNbElement) where T : IFloatingPointIeee754<T> =>
        RisingFallingThreeMethodsImpl<T>(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
