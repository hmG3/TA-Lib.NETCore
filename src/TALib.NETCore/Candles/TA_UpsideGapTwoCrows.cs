...
public static partial class Candles
{
    ...
    ///       <see cref="Core.CandleSettingType.BodyShort">BodyShort</see>. It must gap up relative to the first candle's real body,
    ...
    /// <summary>
    /// Returns the lookback period for <see cref="UpsideGapTwoCrows{T}">UpsideGapTwoCrows</see>.
    /// </summary>
