...
public static partial class Candles
{
    ...
    public static Core.RetCode Harami<T>(
        ...
        HaramiImpl(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
    ...
    private static Core.RetCode Harami<T>(
        ...
        out int outBegIdx,
        out int outNbElement) where T : IFloatingPointIeee754<T> =>
        HaramiImpl<T>(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
