...
public static partial class Candles
{
    ...
    public static Core.RetCode InvertedHammer<T>(
        ...
        InvertedHammerImpl(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
    ...
    private static Core.RetCode InvertedHammer<T>(
        ...
        out int outBegIdx,
        out int outNbElement) where T : IFloatingPointIeee754<T> =>
        InvertedHammerImpl<T>(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
