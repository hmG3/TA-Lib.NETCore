...
public static partial class Candles
{
    ...
    public static Core.RetCode ThreeWhiteSoldiers<T>(
        ...
        ThreeWhiteSoldiersImpl(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
    ...
    private static Core.RetCode ThreeWhiteSoldiers<T>(
        ...
        out int outBegIdx,
        out int outNbElement) where T : IFloatingPointIeee754<T> =>
        ThreeWhiteSoldiersImpl<T>(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement);
