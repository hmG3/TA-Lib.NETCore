...
public static partial class Candles
{
    ...
    public static Core.RetCode EveningStar<T>(
        ...
        EveningStarImpl(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement, optInPenetration);
    ...
    private static Core.RetCode EveningStar<T>(
        ...
        out int outNbElement,
        double optInPenetration = 0.3) where T : IFloatingPointIeee754<T> =>
        EveningStarImpl<T>(inOpen, inHigh, inLow, inClose, startIdx, endIdx, outIntType, out outBegIdx, out outNbElement, optInPenetration);
