...
public class Abstract : IEnumerable<Function>
{
    ...
    internal static readonly Dictionary<string, Function> FunctionsDefinition = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "CdlConcealingBabySwallow", new Function("CdlConcealingBabySwallow", "Concealing Baby Swallow", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        ...
        { "CdlGapSideBySideWhiteLines", new Function("CdlGapSideBySideWhiteLines", "Up/Down-gap side-by-side white lines", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        ...
        { "CdlHikkakeModified", new Function("CdlHikkakeModified", "Modified Hikkake Pattern", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        ...
        { "CdlIdenticalThreeCrows", new Function("CdlIdenticalThreeCrows", "Identical Three Crows", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        ...
        { "CdlRisingFallingThreeMethods", new Function("CdlRisingFallingThreeMethods", "Rising/Falling Three Methods", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        ...
        { "CdlTakuri", new Function("CdlTakuri", "Takuri Line (Dragonfly Doji with very long lower shadow)", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        ...
        { "CdlThreeBlackCrows", new Function("CdlThreeBlackCrows", "Three Black Crows", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        { "CdlThreeInside", new Function("CdlThreeInside", "Three Inside Up/Down", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        { "CdlThreeLineStrike", new Function("CdlThreeLineStrike", "Three-Line Strike", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        { "CdlThreeOutside", new Function("CdlThreeOutside", "Three Outside Up/Down", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        { "CdlThreeStarsInSouth", new Function("CdlThreeStarsInSouth", "Three Stars In The South", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        { "CdlThreeWhiteSoldiers", new Function("CdlThreeWhiteSoldiers", "Three Advancing White Soldiers", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        ...
        { "CdlTwoCrows", new Function("CdlTwoCrows", "Two Crows", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        { "CdlUniqueThreeRiver", new Function("CdlUniqueThreeRiver", "Unique Three River", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        { "CdlUpDownSideGapThreeMethods", new Function("CdlUpDownSideGapThreeMethods", "Upside/Downside Gap Three Methods", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) },
        { "CdlUpsideGapTwoCrows", new Function("CdlUpsideGapTwoCrows", "Upside Gap Two Crows", "Pattern Recognition", $"{OpenInput}|{HighInput}|{LowInput}|{CloseInput}", String.Empty, IntegerOutput) }
    };
